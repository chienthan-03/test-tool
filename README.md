...
- **News veto on technical (2a):** `strategy.newsVeto.enabled` — optional RSS rule-only layer that blocks counter-direction trades on technical setups (macro/hack/etf tags, BTC leader). Operator guide: [HUONG-DAN-FUTURES.md](docs/HUONG-DAN-FUTURES.md) §7.9, spec: [news veto technical](docs/superpowers/specs/2026-05-27-news-veto-technical-design.md).
